            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form action="{{ route('contact.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" name="no_tlp" class="form-control" id="subject" placeholder="Subject">
                                <label for="subject">No Telepon</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" name="isi" placeholder="Leave a message here" id="message"
